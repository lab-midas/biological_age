...
def load_heart_data(data, key, group, ukb=True):
    ...
    print(data.shape)
    #plt.imsave(f'/home/raecker1/nako_ukb_age/experiments/{key}_heart.png', data[:, :, 0], cmap='gray')
...
if __name__ == '__main__':
    ...
    for key in keys:
        if organ == 'brain':
            data = '/mnt/qdata/share/rakuest1/data/UKB/interim/ukb_brain_preprocessed.h5'
            ...
            data = '/mnt/qdata/share/rakuest1/data/UKB/interim/ukb_spl_preprocessed.h5'
            load_abdominal_data(data, key, organ='spleen', contrast='wat', group='', ukb=True)
        elif organ == 'pancreas':
            data = '/mnt/qdata/share/rakuest1/data/UKB/interim/ukb_pnc_preprocessed.h5'
            load_abdominal_data(data, key, organ='pancreas', contrast='wat', group='', ukb=True)
        elif organ == 'kidneys':
            data = '/mnt/qdata/share/rakuest1/data/UKB/interim/ukb_kidney_preprocessed.h5'
